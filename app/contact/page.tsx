                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-600 focus:border-transparent"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-accent-400 text-primary-900 font-semibold py-3 px-6 rounded-lg hover:bg-accent-500 focus:outline-none focus:ring-2 focus:ring-gold-600 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
